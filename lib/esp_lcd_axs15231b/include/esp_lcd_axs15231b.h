...
// Touch API intentionally removed from this local copy — this project uses
// its own touch driver (lib/AXS15231B_Touch), and dropping esp_lcd_touch.h
// avoids pulling in the separate esp_lcd_touch managed component, which
// PlatformIO's Arduino-as-IDF-component build does not fetch automatically.
// Upstream: espressif/esp-iot-solution, components/display/lcd/esp_lcd_axs15231b.
