...
void loadConfigFromNVS(AppConfig &cfg) {
    ...
    cfg.audioOverspeed = prefs.getBool("auOver", cfg.audioOverspeed);
    cfg.audioCamera = prefs.getBool("auCam", cfg.audioCamera);
    cfg.audioLimitAhead = prefs.getBool("auLimit", cfg.audioLimitAhead);
    cfg.audioResident = prefs.getBool("auResid", cfg.audioResident);
    cfg.audioNoOvertake = prefs.getBool("auNoOvt", cfg.audioNoOvertake);
    cfg.audioToll = prefs.getBool("auToll", cfg.audioToll);
    cfg.audioLight = prefs.getBool("auLight", cfg.audioLight);
    cfg.audioDanger = prefs.getBool("auDanger", cfg.audioDanger);
    cfg.audioSystem = prefs.getBool("auSys", cfg.audioSystem);
...
void saveConfigToNVS(const AppConfig &cfg) {
    ...
    prefs.putBool("auOver", cfg.audioOverspeed);
    prefs.putBool("auCam", cfg.audioCamera);
    prefs.putBool("auLimit", cfg.audioLimitAhead);
    prefs.putBool("auResid", cfg.audioResident);
    prefs.putBool("auNoOvt", cfg.audioNoOvertake);
    prefs.putBool("auToll", cfg.audioToll);
    prefs.putBool("auLight", cfg.audioLight);
    prefs.putBool("auDanger", cfg.audioDanger);
    prefs.putBool("auSys", cfg.audioSystem);
